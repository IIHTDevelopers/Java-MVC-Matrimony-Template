...
public class MatrimonyControllerTest {
			...
			yakshaAssert(currentTest(),
					result.getModelAndView() != null && result.getModelAndView().getViewName() != null
							...
							&& asJsonString(expected)
									.equals(asJsonString(result.getModelAndView().getModel().get("matrimonys")))
											? "true"
											: "false",
					businessTestFile);
		} catch (Exception e) {
	...
	public void testControllerListMatrimonys() throws Exception {
		...
		yakshaAssert(currentTest(),
				result.getModelAndView() != null && result.getModelAndView().getViewName() != null
						&& result.getModelAndView().getViewName().contentEquals("list-matrimonys")
						&& asJsonString(expected)
								.equals(asJsonString(result.getModelAndView().getModel().get("matrimonys"))) ? "true"
										: "false",
				businessTestFile);
	}
	...
	public void testControllerShowFormForAdd() throws Exception {
		...
		yakshaAssert(currentTest(),
				result.getModelAndView() != null && result.getModelAndView().getViewName() != null
						&& result.getModelAndView().getViewName().contentEquals("add-matrimony-form"),
				businessTestFile);
	}
	...
	public void testControllerSaveMatrimony() throws Exception {
		...
		MvcResult result = this.mockMvc.perform(post("/saveMatrimony").flashAttr("matrimony", matrimony)).andReturn();
		yakshaAssert(currentTest(),
				result.getModelAndView() != null && result.getModelAndView().getViewName() != null
						&& result.getModelAndView().getViewName().contentEquals("redirect:/matrimony/list"),
				businessTestFile);
	}
	...
	public void testControllerUpdateMatrimonyHasError() throws Exception {
		...
		yakshaAssert(currentTest(),
				result.getModelAndView() != null && result.getModelAndView().getViewName() != null
						&& result.getModelAndView().getViewName().contentEquals("update-matrimony-form"),
				businessTestFile);
	}
	...
	public void testControllerShowFormForUpdate() throws Exception {
		...
		MvcResult result = this.mockMvc
				.perform(get("/updateMatrimonyForm").param("matrimonyId", matrimony.getId().toString())).andReturn();
		yakshaAssert(currentTest(),
				result.getModelAndView() != null && result.getModelAndView().getViewName() != null
						&& result.getModelAndView().getViewName().contentEquals("update-matrimony-form"),
				businessTestFile);
	...
	public void testControllerDeleteMatrimony() throws Exception {
		Matrimony matrimony = getMatrimony();
		MvcResult result = this.mockMvc.perform(get("/delete").param("matrimonyId", matrimony.getId().toString()))
				.andReturn();
		yakshaAssert(currentTest(),
				result.getModelAndView() != null && result.getModelAndView().getViewName() != null
						&& result.getModelAndView().getViewName().contentEquals("redirect:/matrimony/list"),
	...
	public void testControllerUpdateMatchFound() throws Exception {
		Matrimony matrimony = getMatrimony();
		MvcResult result = this.mockMvc.perform(get("/updateMatchFound").param("id", matrimony.getId().toString()))
				.andReturn();
		yakshaAssert(currentTest(),
				result.getModelAndView() != null && result.getModelAndView().getViewName() != null
						&& result.getModelAndView().getViewName().contentEquals("redirect:/matrimony/list"),
